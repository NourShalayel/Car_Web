...
<!-- Menu Section Starts -->
        ...
        <div class="collapse navbar-collapse d-flex justify-content-center align-items-center" id="navbarNavAltMarkup">
            <div class="navbar-nav d-flex justify-content-center align-items-center">
                ...
                <a class="nav-item text-white font-weight-bold nav-link ml-3" href="../web/index.php">Home</a>
                <a class="nav-item text-white font-weight-bold nav-link ml-3" href="add_admin.php">Add Admin</a>
<!--                <a class="nav-item text-white font-weight-bold nav-link ml-3" href="add_user.php">Add User</a>-->
                <a class="nav-item text-white font-weight-bold nav-link ml-3" href="Login.php">Login</a>
